<template>
	<div class="mobile-menu" :class="{'--open' : isOpen}">
		<div class="container">
			...
			<nuxt-link class="mobile-menu-link" @click.native="close" to="">Помощь покупателю</nuxt-link>
			<nuxt-link class="mobile-menu-link" @click.native="close" to="">О компании</nuxt-link>
