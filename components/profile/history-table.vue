        ...
        <div v-for="item in order.items" :key="item.id" class="profile-history-product">
          <div class="profile-history-col">
            <div class="profile-history-img">
              <img
                :src="item.product.image ? item.product.image : require('@/static/images/product.png')"
          ...
          <div class="profile-history-col --grow">
            <p class="profile-page-text">
              {{ item.quantity }}
              {{ item.product.tag ? item.product.tag.unit : 'шт' }}
            </p>
          </div>
          <div class="profile-history-col">
        ...
        <ul class="profile-history-list">
          <li class="profile-history-list-item">
            ...
            <p class="profile-page-text">
              ...
              <span v-if="order.index">, {{ order.index }}</span>
            </p>
          </li>
          <li class="profile-history-list-item">
...
export default {
  ...
  methods: {
    ...
    removeOrder(index) {
      this.$store.commit("SET_REMOVE_ORDER", {
        ...this.$getUser().orders[index]
      });
    }
  }
};
