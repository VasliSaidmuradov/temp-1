  ...
  */
  head: {
    ...
    meta: [
      ...
      { "http-equiv": "Content-Security-Policy", content: "default-src *; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://demo-13.brandstudio.kz/api/"}
    ],
    link: [
